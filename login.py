...
header = {
    ...
    "Cookie": "lang=zh-CN",
    "Host": "202.194.116.116",
    "Pragma": "no-cache",
    "Referer": "http://202.194.116.116/srun_portal_pc?ac_id=1&theme=basic1",
    "X-Requested-With": "XMLHttpRequest"

                        ""}

init_url = "http://202.194.116.116"

get_challenge_api = "http://202.194.116.116/cgi-bin/get_challenge"

srun_portal_api = "http://202.194.116.116/cgi-bin/srun_portal"
...
def get_token():
    ...
    get_challenge_params = {
        "callback": "jQuery112409082949098525108_" + str(int(time.time() * 1000)),
        "username": username,
        "ip": ip,
...
def login():
    srun_portal_params = {
        'callback': 'jQuery112407883409393932999_' + str(int(time.time() * 1000)),
        'action': 'login',
        'username': username,
        'password': '{MD5}' + hmd5,
        'ac_id': ac_id,
...
if __name__ == '__main__':
    print("默认使用移动配置")
    username = "19866667777@cmcc" #在这里把@前面的号码改成拥有移动校园网的手机号。
    password = "123123"
    init_getip()
    get_token()
    do_complex_work()
